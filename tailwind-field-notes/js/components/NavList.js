/* =========================================================
   COMPONENT: NavList (js/components/NavList.js)
   Naka-group ngayon per Phase, may phase-label bago bawat grupo
   ========================================================= */
class NavList extends Component {
  ...
  filter(query) {
    ...
    /* itago rin ang phase-label kung walang tugmang topic sa ilalim nito */
